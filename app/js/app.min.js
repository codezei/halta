...
function faq() {
  ...
  var faqQuestions = document.querySelectorAll('.faq__item-question');
  var faqCategories = document.querySelectorAll('.faq__category');
  var activeCategory = faqCategories[0];
  var activeQuestion = faqItems[0];
  var filteringFaqQuestions = [];
